      ...
      <section id="cta" className="w-full py-20 md:py-32 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            ...
            Start free. Deploy in 30 seconds. See results immediately.
          </p>

          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Link href="/forms/builder">
              <Button className="bg-[#c4dfc4] hover:bg-[#b5d0b5] text-[#0a0a0a] px-12 py-7 text-xl font-bold rounded-lg shadow-2xl transform hover:scale-105 transition-all min-h-[64px]">

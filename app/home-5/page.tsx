            ...
            <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
              ...
              <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <Link href="/forms/builder">
                    <Button className="bg-[#c4dfc4] hover:bg-[#b5d0b5] text-[#0a0a0a] px-10 py-7 text-xl font-bold rounded-lg shadow-2xl min-h-[64px]">
            ...
            <section className="py-24 md:py-32 bg-[#0a0a0a]">
              <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                  <Link href="/forms/builder">
                    <Button className="bg-[#c4dfc4] hover:bg-[#b5d0b5] text-[#0a0a0a] px-12 py-7 text-xl font-bold rounded-lg shadow-2xl min-h-[64px]">
                      Create Free Account <ArrowRight className="ml-2 w-6 h-6" />
                    </Button>
                  </Link>
                </div>
